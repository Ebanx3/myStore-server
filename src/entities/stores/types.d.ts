...
interface StoreModel {
     ...
     */
    create: (storeName: string, ownerId: string, maxProducts?: number) => Promise<StoreId>;
     ...
     */
    changeMaxProducts: (storeName: string, newMaxProducts: number) => Promise<boolean>;
     ...
     * @returns A promise that resolves to `true` if the update was successful, otherwise `false`.
     */
    changeCurrentProducts: (storeName: string, newCurrentProducts: number) => Promise<boolean>;
